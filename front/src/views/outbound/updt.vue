...
<script setup>
    ...
    import { useOutboundFindById, canOutboundFindById, canOutboundUpdate, canGoodsFindById } from "@/module";
    ...
    const form = useOutboundFindById(props.id);
