        ...
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="商品销量 " prop="volume" :rules="[{validator:rule.checkNumber, message:'输入一个有效数字'}]">
                        <el-input type="number" placeholder="输入商品销量" style="width: 450px" v-model.number="form.volume" />
                    </el-form-item>
...
<script setup>
    ...
    import { useGoodsFindById, canGoodsFindById, canGoodsUpdate } from "@/module";
    ...
    const form = useGoodsFindById(props.id);
