<template>
    <div class="views-user1-updtself">
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    ...
                    >
                        <el-input disabled type="text" placeholder="输入用户名" style="width: 450px" v-model="form.username" />
                    </el-form-item>

                    <el-form-item label="姓名 " prop="name" required :rules="[{required:true, message:'请填写姓名'}]">
                        <el-input disabled type="text" placeholder="输入姓名" style="width: 450px" v-model="form.name" />
                    </el-form-item>
