<template>
    <div class="views-staff-updtself">
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    ...
                    >
                        <el-input disabled type="text" placeholder="输入工号" style="width: 450px" v-model="form.number1" />
                    </el-form-item>

                    <el-form-item label="姓名 " prop="names" required :rules="[{required:true, message:'请填写姓名'}]">
                        <el-input disabled type="text" placeholder="输入姓名" style="width: 450px" v-model="form.names" />
                    </el-form-item>
