<template>
    <div class="views-cancel-detail">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 取消订单详情 </span>
                    </div>
                </template>
                ...
                <div id="printdetail">
                    <el-descriptions class="margin-top" :column="3" border>
                        ...
                        <el-descriptions-item label="取消原因"> {{ map.reason }} </el-descriptions-item>
...
<script setup>
    ...
    import { useCancelFindById, canCancelFindById } from "@/module";
     ...
     * @type {ECancel}
     */
    const map = useCancelFindById(props.id);
    watch(
        () => props.id,
        (id) => {
    ...
    const dataSets = DB.name("cancelmerchbill").where("cancelid", route.query.id).order("id asc").selectRef();
</script>
