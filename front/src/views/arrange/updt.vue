...
<script setup>
    ...
    import { useArrangeFindById, canArrangeFindById, canArrangeUpdate, canReservationFindById } from "@/module";
    ...
    const form = useArrangeFindById(props.id);
