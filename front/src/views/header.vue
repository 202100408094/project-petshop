        ...
        <div class="header-top">
            <div class="auto-1400 clearfix">
                ...
                <div class="top-right fr">
                    <ul>
                        <li>欢迎访问{{ config.title }}</li>
                        <template v-if="$session.cx == '用户'">
                            <li class="cart" @click="$router.push('/shoppingcart')">
                            <span class="ico">
                                <i class="fa fa-shopping-cart"></i>
                            </span>
                                <span>购物车</span>
                                <span class="cart-num">{{ gouwucheCount }}</span>
                            </li>
                        </template>
            ...
            <div class="main-box ms300">
                <div class="auto-1400">
                    <div class="logo-box fl">
                        <div class="logo">
                            <a  style="color: #cc0000" href="javascript:;" title="">
                                以爱之名，打造宠物的温馨小世界。
                            </a>
                        </div>
                    </div>
                    ...
                    <nav class="main-menu ms300 fl">
                        ...
                        <ul class="navigation">
                            ...
                            <li :class="{'active-menu':isFullPathActive({path:'/goods'})}">
                                <router-link :to="{path:'/goods'}" title="宠物用品"> 宠物用品 </router-link>
                            </li>
                            <li :class="{'active-menu':isFullPathActive({path:'/services'})}">
                                <router-link :to="{path:'/services'}" title="宠物服务"> 宠物服务 </router-link>
                            </li>
                            <li :class="{'active-menu':isFullPathActive({path:'/petlnformation'})}">
                                <router-link :to="{path:'/petlnformation'}" title="宠物资讯"> 宠物资讯 </router-link>
                            </li>
                            <li :class="{'active-menu':isFullPathActive({path:'/user1/add'})}">
                                <router-link :to="{path:'/user1/add'}" title="用户注册"> 用户注册 </router-link>
                            </li>
...
<script setup>
    ...
    const gouwucheCount = ref(0);
    const loadGouwucheList = async () => {
        if (session("username")) {
            gouwucheCount.value = await DB.name("shoppingcart").where("userss", session("username")).count();
        } else {
            gouwucheCount.value = 0;
        }
    };
    loadGouwucheList();
    useEvent("shoppingcart_change", loadGouwucheList);
    watch(() => userState, loadGouwucheList, { deep: true });
