...
public class ServicesService {
     ...
     *  根据id 获取一行数据
     */
    public R<Services> findById(Integer id) {
     ...
     *  根据Wrapper 对象进行数据筛选
     */
    public R<List<Services>> selectAll(Wrapper<Services> query) {
    ...
    public R<List<Services>> selectAll() {
        QueryWrapper<Services> wrapper = Wrappers.query();
    ...
    public R selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Services> wrapper = mapToWrapper(map);
        // 设置排序
     ...
     */
    public QueryWrapper<Services> mapToWrapper(Map<String, Object> map) {
        // 创建 QueryWrapper 对象
        QueryWrapper<Services> wrapper = Wrappers.query();
    ...
    public R selectPages(QueryWrapper<Services> wrapper, IPage page) {
     ...
     * @return 是否处理成功
     */
    public R insert(Services entityData, Map post) {
        // 判断是否有填写编号。
        ...
        // 判断是否有填写类型。
        if (StringUtil.isNullOrEmpty(post.get("type"))) {
            return R.error("请填写类型");
        }
        // 判断是否有填写图片。
     ...
     * @return 是否处理成功
     */
    public R<Object> update(Services entityData, Map post) {
        // 判断是否有填写编号。
        if (StringUtil.isNullOrEmpty(post.get("numbers"))) {
            return R.error("请填写编号");
        }
