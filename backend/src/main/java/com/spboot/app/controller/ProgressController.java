...
import com.spboot.app.service.ProgressService;
...
public class ProgressController {
    ...
    public R<List<Progress>> selectAll() {
        return progressService.selectAll();
    }

    @ApiOperation(value = "根据条件筛选获取管理员列表，并分页", httpMethod = "POST")
    @RequestMapping("/selectPages")
    public R selectPages(@RequestBody Map<String, Object> req) {
        return progressService.selectPages(req);
    }
    ...
    public R selectUserss(@RequestBody Map<String, Object> req) {
        return progressService.selectPagesUserss(req);
    }
    ...
    @ApiImplicitParam(name = "data", value = "使用json数据提交", type = "json", dataTypeClass = Progress.class, paramType = "body")
    public R update(@RequestBody Map data) {
        Progress post = BeanUtil.mapToBean(data, Progress.class, true);
        return progressService.update(post, data);
    }
    ...
    public R insert(@RequestBody Map data) {
        Progress post = BeanUtil.mapToBean(data, Progress.class, true);
        return progressService.insert(post, data);
    }
